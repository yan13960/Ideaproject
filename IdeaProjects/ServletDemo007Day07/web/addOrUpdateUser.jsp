...
<br>
看看是什么：  ${msg=='2'  ?   'updateUser.do'   :  'addUser.do'}

<form action="${pageContext.request.contextPath}/${msg=='2'  ?   'updateUser.do'   :  'addUser.do'}" method="post" onsubmit="return cccc();">
